...
**Current focus:** v3.3 Mind — In-World Faculties. ✅ Phase 72 `aisthesis` (in-world perception) shipped 2026-07-10 (faculty + on_tick input-edge hook + get_state; 18 tests, brain suite 1186 green, state-hash still 4). NEXT: Phase 73 `praxis` (in-world action). Design: `docs/plans/2026-07-10-nous-inworld-faculties-design.md`. (Parallel track still open: v3.2 Money 62.5-04/05 per stopped_at pointer above.)
