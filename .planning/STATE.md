...
**Current focus:** v3.3 Mind — In-World Faculties. ✅ Phase 72 `aisthesis` (perception, input edge) + ✅ Phase 73 `praxis` (action, output edge) shipped 2026-07-10 (faculties + on_tick hooks + get_state; brain suite 1205 green, state-hash still 4). NEXT: Phase 74 `synopsis` (in-world research → episteme). Design: `docs/plans/2026-07-10-nous-inworld-faculties-design.md`. (Parallel track still open: v3.2 Money 62.5-04/05 per stopped_at pointer above.)
