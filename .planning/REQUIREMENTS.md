...
- [ ] **DRIVE-01**: Ananke subsystem runs 5 drives at MVP — **hunger, curiosity, safety, boredom, loneliness** — each a numeric value in `[0.0, 1.0]`. Drives are pure Python in `brain/src/ananke/drives.py`, no external library. New drives are a v2.3 decision; MVP enum is closed.
