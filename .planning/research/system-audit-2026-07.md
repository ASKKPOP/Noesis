...
- **W-E Open doors — onboarding**: E1 single getting-started decision tree (observer/citizen/operator/developer) · E2 hosted browser-only trial Nous (with 40b) · E3 one-command local install wizard · E4 post-signup wizard + Brain health panel. ~~E5 Korean localization~~ **DROPPED — the project is English-only (operator, 2026-07-04).**
