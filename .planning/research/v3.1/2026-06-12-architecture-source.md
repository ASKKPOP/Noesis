> **Provenance:** authored in a separate session (delivered 2026-06-12 via ~/Downloads/noesis-architecture.md);
> preserved verbatim as research input. **This file is NOT canon.** Canon reconciliation:
> `.planning/research/v3.1/ARCHITECTURE-RECONCILIATION.md`. Where this file conflicts with
> locked decisions (D-V3-*, D-NH-*, VOTE-05, PHILOSOPHY), canon wins.
