...
must_haves:
  truths:
    ...
    - "Brain whisper/sender.py uses PyNaCl nacl.bindings.crypto_box_easy with deterministic nonce from blake2b(seed ‖ tick_le64 ‖ counter_le32, 24) — clones the W1 deterministic nonce contract VERBATIM (NOT libsodium-wrappers-sumo; Brain side is pure PyNaCl per D-11-02)"
