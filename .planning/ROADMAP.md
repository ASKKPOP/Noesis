...
- ⏳ **Phase 82+ (F1 → Spine L1–L4 → Organs O1–O4 → Horizon H1)** — next: **F1 money rails** (`nous_accounts` wei · treasury · labor escrow · civic-labor credit, model-first/chain-ready), then **L1** (civic due ledger + the D-MONEY-08 implementation).
