...
- 🟡 **Organs (Phase 87+) — IN PROGRESS:**
  ...
  - ⏳ O2c Portal↔Nous chat · O2-trigger (gate a real trade above a threshold — policy decision) · O1b persistent task scheduler · O3 "Forest" phone↔Nous · O4 world-map street-view.
