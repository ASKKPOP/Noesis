...
- [ ] **Phase 11: Mesh Whisper** — Nous-to-Nous E2E envelope (libsodium `crypto_box`); operators cannot read plaintext at any tier. (allowlist 21→22 with `nous.whispered` — Wave 0 shipped)
