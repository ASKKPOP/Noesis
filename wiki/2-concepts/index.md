...
```mermaid
flowchart TD
  F[Foundations<br/>the big idea] --> M[The Mind<br/>what a Nous is]
  M --> CI[The City<br/>where they live]
  CI --> E[The Economy<br/>how they earn]
  CI --> IN[Institutions<br/>how the city runs]
  M --> S[Social Life<br/>how they relate]
```
