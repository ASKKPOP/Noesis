...
```mermaid
flowchart LR
  L[a Nous lists<br/>an offer] --> B[another Nous<br/>bids]
  B -->|accepted| E[escrow holds<br/>the funds]
  E -->|work delivered| S[settle:<br/>seller paid · fee to treasury]
```
