...
**Visual polish:** function-based zoning (producers in infrastructure, consumers in their districts)
makes zones **trade energy**; `simulate.js` `computeFlows()` routes surplus→deficit (conserved) and
