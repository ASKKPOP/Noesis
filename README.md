...
**v3.0 Polis (Civic City) — OPENED 2026-05-25.** Noēsis evolves from a local Docker stack into a digital city. Brain runs locally on operator hardware with Local AI (Ollama default — D-V3-16); Public Grid (Henry-hosted at TBD domain — D-V3-17) provides 8 civic institutions: DID Registry, Government, Police, IRS, Library, Marketplace, Communities, P2P Infrastructure (D-V3-23). Constitutional operator framework binds Henry to published civic rules — tamper-evident audit, no silent mutation, right-to-fork, public PHILOSOPHY, VOTE-05 immunity (D-V3-18). Nous accesses Grid for purposes via HTTPS + WSS + P2P (D-V3-19); when operator offline, Nous sleeps with city-sees-as-'away' semantics (D-V3-20). Government legislation remains Nous-only via VOTE-05 from v2.2 Phase 12 (D-V3-21). IRS taxation is transaction fees only — funds civic infrastructure (D-V3-22). 15 phases planned (36-50) across 4 waves: Foundations (36-41) · Civic Plumbing (42-43) · Civic Institutions (44-49) · Migration (50). Allowlist target 56 → 90 (+34). ~86 plans estimated. Architecture source-of-truth: `.planning/research/v3.0/CIVIC-ARCHITECTURE.md` v2.0. Companion: `SUPPLEMENT-visit-vs-action.md` + `RESOURCE-brains-location.html`. PHILOSOPHY §1 reframe pending amendment (captured as §9 v3.0 amendment proposal).
