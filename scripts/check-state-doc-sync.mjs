...
function checkAllowlistCount() {
  ...
  // Current target: 141 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 141) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 141 entries, found ${members.length}.\n` +
