...
function checkAllowlistCount() {
  ...
  // Current target: 136 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 136) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 136 entries, found ${members.length}.\n` +
