...
function checkAllowlistCount() {
  ...
  // Current target: 123 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 123) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 123 entries, found ${members.length}.\n` +
