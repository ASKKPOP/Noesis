...
function checkAllowlistCount() {
  ...
  // Current target: 139 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 139) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 139 entries, found ${members.length}.\n` +
