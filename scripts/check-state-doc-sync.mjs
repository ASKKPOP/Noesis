...
function checkAllowlistCount() {
  ...
  // Current target: 155 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 155) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 155 entries, found ${members.length}.\n` +
