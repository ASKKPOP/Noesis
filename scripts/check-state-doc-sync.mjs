...
function checkAllowlistCount() {
  ...
  // Current target: 134 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 134) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 134 entries, found ${members.length}.\n` +
