...
function checkAllowlistCount() {
  ...
  // Current target: 131 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 131) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 131 entries, found ${members.length}.\n` +
