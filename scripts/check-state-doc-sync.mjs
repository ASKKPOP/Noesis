...
function checkAllowlistCount() {
  ...
  // Current target: 129 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 129) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 129 entries, found ${members.length}.\n` +
