...
function checkAllowlistCount() {
  ...
  // Current target: 144 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 144) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 144 entries, found ${members.length}.\n` +
