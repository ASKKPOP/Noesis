...
function checkAllowlistCount() {
  ...
  // Current target: 127 members. Growth since Phase 48b (86): the Economic Reality Loop +
  ...
  if (members.length !== 127) {
    failures.push(
      `ALLOWLIST_MEMBERS count mismatch: expected 127 entries, found ${members.length}.\n` +
