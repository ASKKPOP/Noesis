 ...
 * to Nous DIDs (not operator IDs).
 *
 * Phase 12 Wave 3 — VOTE-01 / VOTE-05 / D-12-05 / D-12-06 / T-09-16.
 *
 * SECURITY 2026-07-10: the former validateTierAtLeast (which read the spoofable
 * x-operator-tier header) is RETIRED. Operator-tier reads (proposal body / ballot
 * history) now go through the server-trusted operator_only gate — tier is resolved
 * from the Portal-session DID + GRID_OPERATOR_DIDS allowlist (req.didContext.operatorTier).
 *
