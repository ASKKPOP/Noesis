...
// Re-export so existing import sites that reference these from brain-hash-state-client.ts keep working.
export { BrainUnreachableError, BrainUnknownDidError, BrainMalformedResponseError };
