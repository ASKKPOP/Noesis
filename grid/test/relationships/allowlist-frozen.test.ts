...
describe('SC#5 — broadcast allowlist is frozen across Phase 9 (Phase 10b-adjusted baseline)', () => {
    it('BROADCAST_ALLOWLIST length === 43 (Phase 20 baseline: +2 lore.* events since Phase 19)', () => {
        ...
        // Phase 15 (REFLEX-02) added nous.reflection_authored, nous.self_model_revised,
        // nous.creed_violation at positions 28-30.
        // Phase 16 (SLEEP-01) added nous.sleep.entered, nous.sleep.completed at positions 31-32.
