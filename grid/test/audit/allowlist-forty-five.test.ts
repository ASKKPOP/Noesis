...
describe('broadcast allowlist — Phase 24 end-state (45 events)', () => {
    it('has exactly 45 members at Phase 24 end-state (allowlist has since grown to 53)', () => {
        // Allowlist grew in Phase 25b (+6), Phase 27 (+1), Phase 28 (+1); verify positional invariants
        // for Phases 22-24 hold while acknowledging the current size is 53.
