...
describe('broadcast-allowlist: default-deny membership', () => {
    it('has 158 locked event types (v1..Phase 55 + W-C3 orbital.object_upgraded)', () => {
        expect(ALLOWLIST.size).toBe(158);
    });

    it('has frozen 158-member allowlist (ALLOWLIST_MEMBERS array length)', () => {
